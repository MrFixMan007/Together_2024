package com.example.profsoft_2024_final_task.navigation
...
import com.example.profsoft_2024_final_task.thirdscreen.ThirdScreen
...
fun NavController.navigateToThirdScreen(
    ...
    this.navigate("$THIRD_SCREEN_ROUTE/$firstName/$lastName/$patronymic/$birthday")
}
...
fun NavGraphBuilder.thirdScreen(
    ...
    composable(
        route = "$THIRD_SCREEN_ROUTE/{$FIRST_NAME_KEY}/{$LAST_NAME_KEY}/{$PATRONYMIC_KEY}/{$BIRTHDAY_KEY}",
        arguments = listOf(
